...
% TODO: Add TikZ illustration of a walled garden showing:
% - A protective wall/fence enclosing only trusted devices
% - Inside the wall: user's computer and friends' computers (labeled as "Trusted")
% - Outside the wall: servers, internet infrastructure, other users (labeled as "Untrusted")
% - Visual metaphor showing that Anysphere's trust model only extends to devices within the "walled garden" 
