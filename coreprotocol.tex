...
% 🥚 EASTER EGG: This is where the magic happens! ✨
% Fun fact: Alice and Bob have been talking to each other in cryptography papers since 1978
% They're probably tired of being spied on by Eve by now
...
% 🥚 EASTER EGG: "constant rate" = Alice can't binge-send memes at 3 AM without everyone knowing
...
% 🥚 EASTER EGG: Alice's random bytes are probably more interesting than most of her actual messages
% 🥚 EASTER EGG: 1 KB every minute = 1440 KB per day = enough for a lot of "hey" messages
