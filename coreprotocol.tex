...
% Easter egg: Alice and Bob are the canonical cryptography protagonists, but sometimes Eve (the eavesdropper) tries to interfere. In our case, Eve can't even tell if Alice and Bob are talking!
