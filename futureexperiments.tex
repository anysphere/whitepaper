...
\textbf{The ACK problem.} Currently, if Alice wants to send a 2 KB message to Bob, she needs to wait for Bob to get online and ACK the first chunk before she can send the second chunk. If Alice's and Bob's time zones do not overlap, this can mean that an $n$ KB message takes $n$ days to get delivered. This is why we recommend against sending "breaking up" messages — they might take weeks to arrive\footnote{To be fair, this gives both parties time for reflection.}.
